...
export const DEFAULT_TRACKS: Track[] = [
  {
    ...
    swing: 50, volume: 0.8, mute: false, solo: false,
    fmParams: {
  ...
  {
    id: 1, name: 'Bass', midiNote: 24, mode: 'sample',
    swing: 50, volume: 0.8, mute: false, solo: false,
  },
  {
  ...
  },
  {
    ...
    swing: 50, volume: 0.6, mute: false, solo: false,
    sampleVariant: 'chh',
  },
  {
    id: 4, name: 'Clap', midiNote: 39, mode: 'sample',
    swing: 50, volume: 0.7, mute: false, solo: false,
  },
  {
  ...
  },
  {
    ...
    swing: 50, volume: 0.5, mute: false, solo: false,
  },
  {
  ...
  },
  {
    ...
    swing: 50, volume: 0.4, mute: false, solo: false,
  },
];
